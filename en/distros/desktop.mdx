...
Desktop image is a lightweight yet feature-rich desktop environment designed for
...
- **X11 over Wayland**: Wayland offers modern features but is not yet mature enough for T3 Gemstone boards. Many
  applications still rely on X11, and we prioritized stability for our users. 
  ([Adaptation work continues.](/en/roadmap#wayland-transition))
