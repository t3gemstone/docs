...
<Note>
To become a Volunteer Developer, you need to read all the documentation, review the projects on GitHub,
and choose one of the topics below to work on. Visit the [community forum](https://community.t3gemstone.org)
for your questions.
</Note>
