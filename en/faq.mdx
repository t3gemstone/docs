...
<AccordionGroup>
  ...
  <Accordion title="What are the Development Rules?">
    ...
    * All files to be uploaded to the documentation must be selected in lowercase, containing only UTF8 characters,
      and with hyphens between words. For example, 'browser-en.png'.
  </Accordion>
