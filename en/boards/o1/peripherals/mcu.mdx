...
<Tip>
  This section describes the bare-metal software development process for Cortex-R5 and C7x cores. 
  Software running on the relevant architectures is compiled using Texas SDK and tools and loaded
