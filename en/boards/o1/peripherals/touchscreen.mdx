...
- How to connect a DSI touchscreens to the Gemstone O1 development board.
- Adding overlays.
</Tip>
...
<Steps>
  <Step title="Making the Cable Connection">
    The cable between the screen and the Gemstone O1 development board must be connected correctly.
  </Step>
...
To properly connect the cable between the screen and the Gemstone O1 development board, you must connect it to the DSI0 connector (the one near the Ethernet socket) as shown in the photo below.
<Tip>
