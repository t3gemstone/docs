...
<Tip>
Depending on the operating system, the serial port targets to connect to are as follows.

- Linux: `/dev/ttyUSB*`
- macOS: `/dev/cu.usbserial*` or `/dev/cu.usbmodem*`
- Windows: `COM*`

You can identify which port it is via the terminal using the following commands.
