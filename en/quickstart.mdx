...
(Linux, Windows, or macOS) for your computer from https://www.t3gemstone.org/software.
...
Imager application: https://packages.t3gemstone.org/imager/
</Tip>
...
<Tabs>
  <Tab title="Linux">
    After downloading the file with the **.AppImage** extension for the Linux operating system,
    right-click it and open the Properties screen. Then, from the "Permissions" section, check
    the "Allow executing file as program" option.
  
    <Frame>
      <img height="400" width="400" src="/images/gem-imager/linux-chmod-a.png" />
    </Frame>
  
    To make it executable, you can also open a terminal in the directory where you downloaded the file and run the command:  
    `chmod +x GemImager-1.1.1.AppImage`
