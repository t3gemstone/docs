...
| Task | Model | Required Processing Power |
|------|-------|--------------------------|
| Target detection (F-16 / helicopter / missile / UAV) | yolox_s_lite | 1–1.5 TOPS |
| Friend/foe classification | mobilenet_v2_lite | 0.5 TOPS |
| Moving target tracking | yolox_s_lite | 1–1.5 TOPS |
