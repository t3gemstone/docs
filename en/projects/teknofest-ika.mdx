...
flowchart TB
    subgraph EXTERNAL["External Hardware"]
        GPS["GPS Module (UART-MAIN6)"]
        RC["RC Receiver / SBUS (UART-MAIN1)"]
        ESC1["PWM ESC Drive Motor"]
        ESC2["DroneCAN ESC"]
        SRV["Servo Turret / Firing"]
        GCS["Ground Station (QGroundControl)"]
    end
