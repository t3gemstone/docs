---
title: 'Distro'
description: 'Gemstone için GNU/Linux Dağıtımı Oluşturma'
---
...
<Tooltip tip="ubuntu-22, ubuntu-24, debian-11, debian-12">4 Dağıtım</Tooltip> bulunmaktadır.
<Tooltip tip="Desktop, Kiosk, Minimal">3 İmaj Türü</Tooltip>
<Tooltip tip="beagley-ai, intel-corei7-64, t3-gem-o1, qemuarm64">4 Makine</Tooltip>
...
<ParamField body="t3-gem-o1" type="MACHINE=t3-gem-o1 DISTRO_ARCH=arm64">
T3 Gemstone Obsidyen geliştirme kartına ait makine türüdür.
</ParamField>

<ParamField body="intel-corei7-64" type="MACHINE=intel-corei7-64 DISTRO_ARCH=amd64">
...
<ParamField body="qemuarm64" type="MACHINE=qemuarm64 DISTRO_ARCH=arm64">
QEMU ile sanal olarak kullanmak için tercih edilmektedir.
</ParamField>
