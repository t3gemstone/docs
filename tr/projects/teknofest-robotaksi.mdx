...
Gerçek araç testleri; alan, ekipman ve güvenlik koşulları gerektirdiğinden her aşamada uygulanamaz. T3 Gemstone O1 üzerinde çalışan ROS 2 yazılımları Gazebo veya CARLA simülatörleriyle doğrudan test edilerek algoritmalar gerçek araca taşınmadan önce doğrulanabilir.
