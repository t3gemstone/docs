...
<Warning>
Home Assistant kurulumu yalnızca **Debian** imajlarında çalışmaktadır. Ubuntu gibi diğer
dağıtımların imajlarında Home Assistant Supervisor hizmeti düzgün çalışmadığı için desteklenmemektedir.
Bu nedenle karta imaj yazarken [Karta yüklenecek işletim sistemini seç](/tr/quickstart#1-2-4-karta-yüklenecek-işletim-sistemini-seç)
bölümünde anlatıldığı gibi bir Debian imajı seçtiğinizden emin olunuz.
</Warning>
...
Kurulum tamamlandıktan sonra Home Assistant hizmetlerinin doğru şekilde başlatılabilmesi için geliştirme kartını
...
Kart yeniden başladıktan sonra Supervisor’ın tüm hizmetleri indirip ayağa kaldırması internet hızınıza bağlı olarak 5-10 dakika sürebilir. 
...
<Frame caption="Home Assistant ESPHome Yüklendikten Sonra">
  <img src="/images/homeassistant/tr/esphome-installed.png" alt="Home Assistant ESPHome Yüklendikten Sonra" />
</Frame>

Yükleme tamamlandıktan sonra görüntülenen menüde başlat butonuna tıklanır.

<Frame caption="Home Assistant ESPHome Yüklendikten Sonra">
  <img src="/images/homeassistant/tr/esphome-installed-2.png" alt="Home Assistant ESPHome Yüklendikten Sonra" />
</Frame>

"Web Arayüzünü Aç" butonuna tıklanır.

<Frame caption="ESPHome Hoşgeldin Ekranı">
  <img src="/images/homeassistant/tr/esphome-welcome.png" alt="ESPHome Hoşgeldin Ekranı" />
</Frame>
...
<Frame caption="ESPHome Yeni Cihaz Ekleme Ekranı">
  <img src="/images/homeassistant/tr/esphome-add-device.png" alt="ESPHome Yeni Cihaz Ekleme Ekranı" />
</Frame>

"Create new project" butonuna tıklanarak işlem devam ettirilir.

<Frame caption="ESPHome Cihaz Konfigürasyon Ekranı">
  <img src="/images/homeassistant/tr/esphome-device-config.png" alt="ESPHome Cihaz Konfigürasyon Ekranı" />
</Frame>

Açılan sayfada kullanacağınız MCU modeline göre arama yapılır.

<Frame caption="ESPHome Cihaz Konfigürasyon Ekranı">
  <img src="/images/homeassistant/tr/esphome-device-config-2.png" alt="ESPHome Cihaz Konfigürasyon Ekranı" />
</Frame>

Bu adımda, uygun model seçilir.

<Frame caption="ESPHome Cihaz Tip Seçim Ekranı">
  <img src="/images/homeassistant/tr/esphome-device-name.png" alt="ESPHome Cihaz Tip Seçim Ekranı" />
</Frame>

Bu adımda, karta bir isim konulması gerekmektedir..

<Frame caption="ESPHome Cihaz Konfigürasyonun Tamamlanması">
  <img src="/images/homeassistant/tr/esphome-device-wifi.png" alt="ESPHome Cihaz Konfigürasyonun Tamamlanması" />
</Frame>
...
<Frame caption="ESPHome YAML Dosyasına Sensör Ekleme">
  <img src="/images/homeassistant/tr/esphome-add-sensor.png" alt="ESPHome YAML Dosyasına Sensör Ekleme" />
</Frame>
...
<Frame caption="ESPHome Yazılım Yükleme Seçenekleri">
  <img src="/images/homeassistant/tr/esphome-flash-options.png" alt="ESPHome Yazılım Yükleme Seçenekleri" />
</Frame>
...
<Frame caption="ESPHome Yazılım Yükleme">
  <img src="/images/homeassistant/tr/esphome-flashing.png" alt="ESPHome Yazılım Yükleme" />
</Frame>
...
<Frame caption="ESPHome Yazılım Yükleme Log Ekranı">
  <img src="/images/homeassistant/tr/esphome-flash-log.png" alt="ESPHome Yazılım Yükleme Log Ekranı" />
</Frame>

Yükleme işlemi başlatılır. İlk yükleme, biraz zaman alabileceği için sabırlı olunması önerilir.

<Frame caption="ESPHome Yazılım Yükleme Log Ekranı">
  <img src="/images/homeassistant/tr/esphome-flash-log-2.png" alt="ESPHome Yazılım Yükleme Log Ekranı" />
</Frame>
...
<Frame caption="ESPHome cihazı Ekleme">
  <img src="/images/homeassistant/tr/esphome-find.png" alt="ESPHome cihazı Ekleme" />
</Frame>
...
<Frame caption="ESPHome cihazı Ekleme">
  <img src="/images/homeassistant/tr/esphome-add-device-homeassistant.png" alt="ESPHome cihazı Ekleme" />
</Frame>

Bu aşamada karşımıza çıkan **Gönder** butonuna tıklanır.

<Frame caption="ESPHome cihazı Ekleme">
  <img src="/images/homeassistant/tr/esphome-homeassistant-name.png" alt="ESPHome cihazı Ekleme" />
</Frame>

Bu adımda ise karta Home Assistant için bir isim verilir. Sonrasında **Atla ve Bitir** butonuna tıklanarak devam edilebilir.

<Frame caption="ESPHome Cihazlar">
  <img src="/images/homeassistant/tr/esphome-devices.png" alt="ESPHome Cihazlar" />
</Frame>

**ESPHome** altında yer alan **"1 cihaz"** seçeneğine tıklanır.

<Frame caption="ESPHome Cihaz Detayları">
  <img src="/images/homeassistant/tr/esphome-device-details.png" alt="ESPHome Cihaz Detayları" />
</Frame>
