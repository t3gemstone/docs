...
<Frame caption="Home Assistant Hazırlanma Ekranı">
  <img src="/images/homeassistant/tr/preparation.png" alt="Hazırlanma Ekranı" />
</Frame>
...
<Frame caption="Home Assistant Hoş Geldiniz Ekranı">
  <img src="/images/homeassistant/tr/welcome.png" alt="Hoş Geldiniz Ekranı" />
</Frame>
...
<Frame caption="Home Assistant Kullanıcı Oluşturma Ekranı">
  <img src="/images/homeassistant/tr/user-creation.png" alt="Kullanıcı Oluşturma" />
</Frame>
...
<Frame caption="Home Assistant Ev Konumu Seçim Ekranı">
  <img src="/images/homeassistant/tr/home-location.png" alt="Ev Konumu" />
</Frame>

Cihazınınız bulunduğu lokasyonu yani **Ev Konumu**nu seçebilirsiniz.

<Frame caption="Home Assistan Veri Paylaşımı Seçim Ekranı">
  <img src="/images/homeassistant/tr/data-sharing.png" alt="Veri Paylaşımı" />
</Frame>
...
<Frame caption="Home Assistant Ana Ekran">
  <img src="/images/homeassistant/tr/main.png" alt="Ana Ekran" />
</Frame>
...
<Frame caption="Home Assistant Ana Ekran">
  <img src="/images/homeassistant/tr/main.png" alt="Home Assistant Ana Ekran" />
</Frame>

Sol taraftaki menü açıldıktan sonra, Ayarlar seçeneğine tıklanır.

<Frame caption="Home Assistant Ayarlar Bölümü">
  <img src="/images/homeassistant/tr/settings.png" alt="Home Assistant Ayarlar Bölümü" />
</Frame>

Açılan menüden Uygulamalar seçeneği seçilir.

<Frame caption="Home Assistant Ayarlar Bölümü">
  <img src="/images/homeassistant/tr/settings-2.png" alt="Home Assistant Uygulamalar Bölümü" />
</Frame>

Sağ alt köşede bulunan "Uygulamayı Yükle" butonuna tıklanır.

<Frame caption="Home Assistant Uygulama Mağazası">
  <img src="/images/homeassistant/tr/app-store.png" alt="Home Assistant Uygulama Mağazası" />
</Frame>

Açılan menüdeki arama alanına "esphome" yazılır.

<Frame caption="Home Assistant Uygulama Mağazası Arama Sonucu">
  <img src="/images/homeassistant/tr/app-store-search.png" alt="Home Assistant Uygulama Mağazası Arama Sonucu" />
</Frame>

Arama sonuçlarında görüntülenen ESPHome seçeneğine tıklanır.

<Frame caption="Home Assistant ESPHome">
  <img src="/images/homeassistant/tr/esphome.png" alt="Adım f" />
</Frame>
...
<Frame caption="Home Assistant ESPHome Yüklendikten Sonra">
  <img src="/images/homeassistant/tr/esphome-installed.png" alt="Adım g" />
</Frame>
...
<Frame caption="Home Assistant ESPHome Yüklendikten Sonra">
  <img src="/images/homeassistant/tr/esphome-installed-2.png" alt="Adım h" />
</Frame>

"Web Arayüzünü Aç" butonuna tıklanır.

<Frame caption="ESPHome Hoşgeldin Ekranı">
  <img src="/images/homeassistant/tr/esphome-welcome.png" alt="Adım i" />
</Frame>
...
<Frame caption="ESPHome Yeni Cihaz Ekleme Ekranı">
  <img src="/images/homeassistant/tr/esphome-add-device.png" alt="Adım j" />
</Frame>

"Continue" butonuna tıklanarak işlem devam ettirilir.

<Frame caption="ESPHome Cihaz Konfigürasyon Ekranı">
  <img src="/images/homeassistant/tr/esphome-device-config.png" alt="Adım k" />
</Frame>

"New Device Setup" seçeneğine tıklanır.

<Frame caption="ESPHome Cihaz Konfigürasyon Ekranı">
  <img src="/images/homeassistant/tr/esphome-device-config-2.png" alt="Adım l" />
</Frame>
...
<Frame caption="ESPHome Cihaz Tip Seçim Ekranı">
  <img src="/images/homeassistant/tr/esphome-device-type.png" alt="Adım m" />
</Frame>

Bu adımda, "ESP32-S3" seçeneği seçilir.

<Frame caption="ESPHome Cihaz Konfigürasyonun Tamamlanması">
  <img src="/images/homeassistant/tr/esphome-config-complete.png" alt="Adım n" />
</Frame>
...
<Frame caption="ESPHome YAML Dosyasının Düzenlenme Ekranı">
  <img src="/images/homeassistant/tr/esphome-yaml-edit.png" alt="Adım u" />
</Frame>
...
<Frame caption="ESPHome YAML Dosyasına GPIO Tanımlama">
  <img src="/images/homeassistant/tr/esphome-gpio-setup.png" alt="Adım v" />
</Frame>
...
<Frame caption="ESPHome YAML Dosyasına Sensör Ekleme">
  <img src="/images/homeassistant/tr/esphome-add-sensor.png" alt="Adım y" />
</Frame>
...
<Frame caption="ESPHome Yazılım Yükleme Seçenekleri">
  <img src="/images/homeassistant/tr/esphome-flash-options.png" alt="Adım z" />
</Frame>
...
<Frame caption="ESPHome Yazılım Yükleme">
  <img src="/images/homeassistant/tr/esphome-flashing.png" alt="Adım a1" />
</Frame>
...
<Frame caption="ESPHome Yazılım Yükleme Log Ekranı">
  <img src="/images/homeassistant/tr/esphome-flash-log.png" alt="Adım b1" />
</Frame>

Yükleme işlemi başlatılır. İlk yükleme, biraz zaman alabileceği için sabırlı olunması önerilir.

<Frame caption="ESPHome Yazılım Yükleme Log Ekranı">
  <img src="/images/homeassistant/tr/esphome-flash-log-2.png" alt="Adım c1" />
</Frame>
...
<Frame caption="ESPHome IP Adresi Ekleme">
  <img src="/images/homeassistant/tr/esphome-add-ip.png" alt="Adım d1" />
</Frame>
...
<Frame caption="ESP Home Cihazlar">
  <img src="/images/homeassistant/tr/esphome-devices.png" alt="Adım e1" />
</Frame>

**ESPHome** altında yer alan **"1 cihaz"** seçeneğine tıklanır.

<Frame caption="ESP Home Cihaz Detayları">
  <img src="/images/homeassistant/tr/esphome-device-details.png" alt="Adım f1" />
</Frame>
