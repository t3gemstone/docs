...
pc@host:examples$ task fetch-ti
```
...
```bash
pc@host:examples$ PROJECT=mcu task clean build
```

### 1.6. Derlenmiş projeyi geliştirme kartına yükle

```bash
pc@host:examples$ scp mcu/hello_world/j722s-evm/mcu-r5fss0-0_freertos/ti-arm-clang/hello_world.release.out gemstone@10.0.0.1:
```
