...
Örneğin `blink_main_r5` isimli bir uygulamayı U-Boot aşamasında main-r5fss0-0 çekirdeğinde çalıştırılmak istendiğinde öncelikle uygulama aşağıda görüldüğü gibi
