...
Aşağıda belirtilen akış şeması Gemstone O1 geliştirme kartı için olmakla birlikte bir çok ARM mimarili gömülü
...
<Tip>
  Bu bölümde Cortex-R5 ve C7x çekirdekleri için Bare-metal yazılım geliştirme süreci anlatılmaktadır. 
  İlgili mimarilerde çalışacak yazılımlar Texas SDK ve araçları ile derlenerek geliştirme kartına yüklenmektedir.
</Tip>
