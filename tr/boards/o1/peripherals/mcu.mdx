...
`2. Boot Diyagramı` bölümündeki şekilde görüldüğü gibi bir önceki bölümde anlatılan çalıştırma yöntemi kullanıldığında mcu uygulamasının çalışabilmesi için
