...
<Danger>
USB takılıyken 12V batarya ters bağlanırsa, geliştirme kartı ciddi şekilde zarar görebilir ve hatta yanma riski oluşabilir. Bu nedenle USB ile güç bağlantısı varken batarya bağlantısını yapmadan önce polarite mutlaka kontrol edilmelidir.
</Danger>
