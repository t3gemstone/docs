...
<Frame caption="Todo: Seri port pinlerinin işaretlendiği kart görseli">
  <img className="rounded-lg" noZoom src="/images/under-construction.png" />
</Frame>

<SnippetDevices int="Arayüz" device="Cihaz" file="Overlay Dosyası" notes="Notlar" />

<Note>
- UART-MAIN0 seri portundan Linux terminaline erişilmektedir.
- `k3-am67a-t3-gem-o1-pwm-epwm0-gpio5-gpio14.dtso` overlay'i aktif edildiği zaman UART-MAIN1 seri portu devre dışı kalmaktadır.
