...
<Tip>DSPLIB kütüphanesini kullanan C7 tabanlı MCU projeleri, işlemcide yer alan DSP hızlandırıcı biriminden
faydalanarak çalışır. Bu sayede filtreleme, konvolüsyon, korelasyon ve benzeri temel DSP işlemleri donanımsal
olarak hızlandırılır ve gerçek zamanlı uygulamalarda yüksek performans elde edilir.</Tip>
...
[Derlenmiş projenin U-Boot aşamasında çalıştırılması](/tr/boards/o1/peripherals/mcu#2-8-derlenmiş-projenin-u-boot-aşamasında-çalıştırılması)
...
[bu bağlantı üzerinden](https://software-dl.ti.com/jacinto7/esd/processor-sdk-rtos-j722s/10_01_00_04/exports/docs/dsplib/docs/user_guide/index.html)
ulaşabilirsiniz.
