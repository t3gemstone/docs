...
<Steps>
  ...
  <Step title="Edge AI Overlay Aktifleştirme">
    ...
    Overlay dosyasını tanımladıktan sonra, yapılan değişikliklerin sistem tarafından uygulanabilmesi için kartın
    yeniden başlatılması gerekilmektedir.
  ...
  <Step title="Ortam Değişkenlerini Yükleme">
    ...
    <Warning>Not: Yapay zeka hızlandırıcılarının kullanılması sebebiyle işlemler donanım seviyesinde
    gerçekleştirilmektedir. Bu nedenle ilgili adımların root kullanıcısı altında yürütülmesi gerekmektedir.</Warning>
  </Step>
