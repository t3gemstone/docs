...
<Tabs>
  <Tab title="Windows">
    <Frame caption="Todo: Denetim Masasından IP adresi ata">
      <img height="200" width="200" src="/images/under-construction.png" />
    </Frame>
  </Tab>
  <Tab title="Linux">
    <Frame caption="Todo: Terminalden veya gnome-settings GUI üzerinden IP ata">
      <img height="200" width="200" src="/images/under-construction.png" />
    </Frame>
  </Tab>
  <Tab title="macOS">
...
Bilgisayarınıza statik IP adresini atadıktan sonra seri port üzerinden kartın
konsoluna erişip aşağıdaki komutları çalıştırınız.

```bash
# eth0-static adinda yeni bir konfigurasyon olusturuyoruz
...
# yeni olusturdugumuz konfigurasyonu DHCP konfigurasyonuna gore daha
# oncelikli yapiyoruz ki IP adresini otomatik olarak almaya calismak
# yerine bizim verdigimiz IP adresini atasin
sudo nmcli connection modify "eth0-static" connection.autoconnect-priority 10
sudo nmcli connection modify "eth0-dhcp" connection.autoconnect-priority 20
```

IP adresleri atandıktan sonra bilgisayarınız ve geliştirme kartınız arasındaki
haberleşmenin başarılı olduğunu görebilmek için aşağıdaki komutu çalıştırınız.

```bash
ping 10.0.0.2
```

#### 2.2.2. Geliştirici (Host) Bilgisayarını Hazırla

<Frame caption="Todo: Host Geliştirici Bilgisayarı Hazırlık">
  <img height="200" width="200" src="/images/under-construction.png" />
</Frame>

#### 2.2.3. Geliştirici (Host) Bilgisayarında Proje Derle

<Frame caption="Todo: Derle">
  <img height="200" width="200" src="/images/under-construction.png" />
</Frame>

#### 2.2.4. Derlenen yazılımları Geliştirme Kartına (Target) yükle
