...
T3-GEM-O1 isimli geliştirme kartının donanım tasarımları (PCB vb.)
...
kullanılmıştır. Debian veya Ubuntu kullanınımı, kart ihtiyaçlarına göre değişkenlik gösterebileceği için farklı
opsiyon olarak sunulmuştur.
...
detaylı anlatımlar yapılmıştır. SDK çalışmasında [Devbox](https://www.jetify.com/devbox), [Distrobox](https://github.com/89luca89/distrobox), 
[Debos](https://github.com/t3gemstone/debos), [Taskfile](https://taskfile.dev/) Her biri çok geniş bilgi
gereksinimlerine ihtiyaç duyulan alanlar olduğu için ilgi alanınıza göre dokümantasyon sonunda
yardımcı kaynaklar verilmiştir.
...
| Proje          | Repo                                | Açıklama |
| :------------- | :---------------------------------- | :------- |
| SDK            | [t3gemstone/sdk](https://github.com/t3gemstone/sdk) | Kernel, U-Boot, Firmware, Driver, Initrd gibi bileşenleri derleyerek işletim sistemi imajı oluşturan yazılım geliştirme kiti |
| Yocto          | [t3gemstone/meta-gemstone](https://github.com/t3gemstone/meta-gemstone) | Yocto projesi kodları |
| Linux Kernel   | [t3gemstone/linux](https://github.com/t3gemstone/linux) | Geliştirme kartlarında kullanılan linux kodları |
...
| Debos          | [t3gemstone/debos](https://github.com/t3gemstone/debos) | Debos isimli projenin klonlanarak bir takım ilave özelliklerin eklendiği dağıtım oluşturma aracı |
| GemImager      | [t3gemstone/gem-imager](https://github.com/t3gemstone/gem-imager) | RpiImager isimli projenin klonlanarak Gemstone kartlarına göre özelleştirilmiş ilave özellikler eklenmiş imaj yazma aracı |
| Hardware       | [t3gemstone/hardware](https://github.com/t3gemstone/hardware) | Gemstone kartlarının anakart vb. donanım bileşenlerinin PCB vb. tasarımları |
| Toolchains     | [t3gemstone/toolchains](https://github.com/t3gemstone/toolchains) | C/C++ gibi projelerin farklı mimarilere göre derlenmesinde kullanılan araç |
| Package Server | [t3gemstone/package-server](https://github.com/t3gemstone/package-server) | packages.t3gemstone.org adresinde bulunan Linux APT paket yönetim sunucusu/sistemi |
| noVNC          | [t3gemstone/t3-gem-vnc](https://github.com/t3gemstone/t3-gem-vnc) | Tarayıcı üzerinden Gemstone'a uzak masaüstü bağlantısı imkanı veren yazılım |
| Ardupilot      | [t3gemstone/ardupilot](https://github.com/t3gemstone/ardupilot) | Gemstone için uyarlanmış insansız araç otopilotu |
| NuttX          | [t3gemstone/nuttx](https://github.com/t3gemstone/nuttx) | PX4 gibi MCU barındıran donanımlarda çalışan gerçek zamanlı işletim sistemi. İlerleyen süreçte Gemstone Obsidyen kartlarında bulunan R5 MCU çekirdeklerinde çalışması sağlanacaktır. |
...
doğrudan kendi bilgisayarınız üzerinde derleyerek karta yüklediğiniz yöntemdir. Aşağıda her iki yöntem ve avantajları
anlatılmıştır.

### 2.1. Kart üzerinde yazılım geliştirme

Gemstone Obsidyen geliştirme kartının üzerinde bulunan sensör, haberleşme veri yolları, kamera, yapay zeka ve network
...
Bir önceki bölümdeki gibi projelerin kart üzerinde derlenmesi mümkünken kullanmakta olduğunuz Dizüstü, Masaüstü
bilgisayarlardaki GNU/Linux işletim sistemini kullanarak derleme yapmanın bir takım avantajları vardır. Örneğin
T3-GEM-O1 kartı 4GB Bellek'e sahipken Dizüstü bilgisayarınız 16/32GB ve daha gelişmiş İşlemciye sahip olabilir.
Dolayısıyla derleme işlemlerini hızlandırmak için Cross Compile Toolchain (Çarpaz Derleme Araçları) kullanılmaktadır.
